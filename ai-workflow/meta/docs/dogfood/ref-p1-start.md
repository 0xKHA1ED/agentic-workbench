# Dogfood (rollup): P1 — Start here (ref-p1-start)

- **Node:** `ref-p1-start` (group) — fragment `fragments/reference-improvements.yaml`
...
- **Evidence:** `tests.test_meta_strong` asserts the whole composed meta tree is
  strong (0 non-strong nodes), which entails every descendant of `ref-p1-start`.

# Scope Contract: Agent executes against spec_approved node

- **Node:** `implement-handoff` (work)
- **Pattern:** `meta/docs/DAILY-LOOP.md`

## GOAL

Agent executes against spec_approved node behaves as specified and stays regression-proof: its VERIFY command

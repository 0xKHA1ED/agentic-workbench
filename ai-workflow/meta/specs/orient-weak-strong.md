# Scope Contract: weak default, strong user-only promotion

- **Node:** `orient-weak-strong` (work)
- **Pattern:** `scripts/project_tree/ops.py`

## GOAL

weak default, strong user-only promotion behaves as specified and stays regression-proof: its VERIFY command

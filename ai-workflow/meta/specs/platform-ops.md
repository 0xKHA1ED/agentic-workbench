# Scope Contract: reparent, mark-stale, set-all-weak

- **Node:** `platform-ops` (work)
- **Pattern:** `scripts/project_tree/ops.py`

## GOAL

reparent, mark-stale, set-all-weak behaves as specified and stays regression-proof: its VERIFY command

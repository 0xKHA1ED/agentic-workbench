# Scope Contract: Package layout + AGENTS.md

- **Node:** `platform-package-layout` (work)
- **Pattern:** `AGENTS.md`

## GOAL

Package layout + AGENTS.md behaves as specified and stays regression-proof: its VERIFY command
passes from a clean checkout and fails if the behavior regresses.

## IN

- The behavior implemented under `AGENTS.md`.

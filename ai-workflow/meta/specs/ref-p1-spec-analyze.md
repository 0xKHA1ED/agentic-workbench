# Scope Contract: spec-analyze — read-only contract/claims gate

- **Node:** `ref-p1-spec-analyze` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

spec-analyze — read-only contract/claims gate behaves as specified and stays regression-proof: its VERIFY command

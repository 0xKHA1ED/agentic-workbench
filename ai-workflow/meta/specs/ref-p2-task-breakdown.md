# Scope Contract: task-breakdown — tasks.md + scoped implement

- **Node:** `ref-p2-task-breakdown` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

task-breakdown — tasks.md + scoped implement behaves as specified and stays regression-proof: its VERIFY command

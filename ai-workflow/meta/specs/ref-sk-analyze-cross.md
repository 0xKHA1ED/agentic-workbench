# Scope Contract: Analyze — claims ↔ contract ↔ VERIFY ↔ IN/OUT consistency

- **Node:** `ref-sk-analyze-cross` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

Analyze — claims ↔ contract ↔ VERIFY ↔ IN/OUT consistency behaves as specified and stays regression-proof: its VERIFY command

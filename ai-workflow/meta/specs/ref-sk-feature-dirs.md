# Scope Contract: Feature directory convention — specs/<id>/ + feature.json pointer

- **Node:** `ref-sk-feature-dirs` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

Feature directory convention — specs/<id>/ + feature.json pointer behaves as specified and stays regression-proof: its VERIFY command

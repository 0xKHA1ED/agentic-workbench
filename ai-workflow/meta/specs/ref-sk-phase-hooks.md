# Scope Contract: Phase hooks — before/after clarify, specify, implement

- **Node:** `ref-sk-phase-hooks` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

Phase hooks — before/after clarify, specify, implement behaves as specified and stays regression-proof: its VERIFY command

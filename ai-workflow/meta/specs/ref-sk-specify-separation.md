# Scope Contract: WHAT/WHY spec vs HOW plan separation in our artifacts

- **Node:** `ref-sk-specify-separation` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

WHAT/WHY spec vs HOW plan separation in our artifacts behaves as specified and stays regression-proof: its VERIFY command

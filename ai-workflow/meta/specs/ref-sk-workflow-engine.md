# Scope Contract: Workflow YAML — daily loop run/resume/gates

- **Node:** `ref-sk-workflow-engine` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

Workflow YAML — daily loop run/resume/gates behaves as specified and stays regression-proof: its VERIFY command

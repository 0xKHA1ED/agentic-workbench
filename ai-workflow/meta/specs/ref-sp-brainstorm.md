# Scope Contract: Brainstorm — spike/bounded/architectural + approval gate

- **Node:** `ref-sp-brainstorm` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

Brainstorm — spike/bounded/architectural + approval gate behaves as specified and stays regression-proof: its VERIFY command

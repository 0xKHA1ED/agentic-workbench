# Scope Contract: request/receive-code-review skills after implement

- **Node:** `ref-sp-code-review` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

request/receive-code-review skills after implement behaves as specified and stays regression-proof: its VERIFY command

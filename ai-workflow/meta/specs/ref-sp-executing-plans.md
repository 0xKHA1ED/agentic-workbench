# Scope Contract: executing-plans — checkbox plan execution

- **Node:** `ref-sp-executing-plans` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

executing-plans — checkbox plan execution behaves as specified and stays regression-proof: its VERIFY command

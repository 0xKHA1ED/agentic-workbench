# Scope Contract: finishing-a-development-branch — merge/PR ritual

- **Node:** `ref-sp-finish-branch` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

finishing-a-development-branch — merge/PR ritual behaves as specified and stays regression-proof: its VERIFY command

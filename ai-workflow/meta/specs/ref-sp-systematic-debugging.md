# Scope Contract: systematic-debugging — pair with /understand for bugs

- **Node:** `ref-sp-systematic-debugging` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

systematic-debugging — pair with /understand for bugs behaves as specified and stays regression-proof: its VERIFY command

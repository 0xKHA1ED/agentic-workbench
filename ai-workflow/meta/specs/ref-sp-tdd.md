# Scope Contract: TDD mode on implement — red/green before VERIFY walk

- **Node:** `ref-sp-tdd` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

TDD mode on implement — red/green before VERIFY walk behaves as specified and stays regression-proof: its VERIFY command

# Scope Contract: verification-before-completion — iron law on done claims

- **Node:** `ref-sp-verify-completion` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

verification-before-completion — iron law on done claims behaves as specified and stays regression-proof: its VERIFY command

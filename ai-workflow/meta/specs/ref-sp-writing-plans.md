# Scope Contract: writing-plans — implementation plan artifact

- **Node:** `ref-sp-writing-plans` (work)
- **Pattern:** `(behavioral — see VERIFY)`

## GOAL

writing-plans — implementation plan artifact behaves as specified and stays regression-proof: its VERIFY command

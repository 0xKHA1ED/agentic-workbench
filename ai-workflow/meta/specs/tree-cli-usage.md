# Scope Contract: Propose / diff / apply workflow

- **Node:** `tree-cli-usage` (work)
- **Pattern:** `scripts/project_tree/cli.py`

## GOAL

Propose / diff / apply workflow behaves as specified and stays regression-proof: its VERIFY command
passes from a clean checkout and fails if the behavior regresses.

## IN

- The behavior implemented under `scripts/project_tree/cli.py`.

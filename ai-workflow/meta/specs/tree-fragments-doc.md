# Scope Contract: Fragment authoring docs

- **Node:** `tree-fragments-doc` (work)
- **Pattern:** `.cursor/skills/project-tree/SKILL.md`

## GOAL

Fragment authoring docs behaves as specified and stays regression-proof: its VERIFY command

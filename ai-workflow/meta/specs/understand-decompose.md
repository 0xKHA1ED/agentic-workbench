# Scope Contract: Split concern into child nodes / fragments

- **Node:** `understand-decompose` (work)
- **Pattern:** `scripts/project_tree/ops.py`

## GOAL

Split concern into child nodes / fragments behaves as specified and stays regression-proof: its VERIFY command
